...
df_copy = pd.read_csv("./datasets/travel_insurance.csv")
...
for n_estimators in range(50):
    classifier = AdaBoostClassifier(base_estimator=tree.DecisionTreeClassifier(), n_estimators=(n_estimators + 1))
